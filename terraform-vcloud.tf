...
resource "vcd_org_vdc" "reham-VDC" {
...
resource "vcd_edgegateway" "Reham-ESG" {
  org                     = "${var.client_vdc_org}"
...
resource "vcd_network_routed" "Reham-Internal-Network" {
